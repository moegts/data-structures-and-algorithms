...
const raisedToTheThird = (arr) => {
  let array = [];
  arr.forEach(i=>{array.push(Math.pow(i, 3));});
  return array;
};
...
const addOne = (arr) => {
  let array= arr.map(i=>{return i+1;});
  return array;
};
...
const forEachTwoToThe = (arr) => {
  let array = [];
  arr.forEach(i=>{array.push(Math.pow(2, i));});
  return array;
};
...
const mapTwoToThe = (arr) => {
  let array = arr.map(i=>{return  Math.pow(2,i);});
  return array;
};
