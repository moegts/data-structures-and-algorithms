...
const typeNum = (arr) => {
  let array = arr.filter(i=>typeof(i) === 'number');
  return array;
};
...
const containsAnd = (arr) => {
  let array = arr.filter(i=>i.includes('and'));
  return array;
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  let array = arr.filter(i=> ! (forbiddenValues.includes(i)));
  console.log(array);
  return array;
};
