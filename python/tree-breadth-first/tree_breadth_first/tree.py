        ...
        try:
            if not self.root: return 'The Tree is empty'
                ...
                while node:
                    ...
                    if node.value > value:
                        if not node.left: return 'The value is not in the Tree'
                        node = node.left
                    else:
                        if node.right == None: return 'The value is nor in the Tree'
                        node = node.right
        except: print("something went wrong please try again")
...
if __name__ == '__main__':
    ...
    tree.add(10) ; tree.add(20)
    tree.add(9) ; tree.add(11)
    tree.add(5)
